...
public class GreenKartTests {
    ...
    void verifyThatTheItemsSortedInCartTest() {
        ...
        try {
            ...
            // Verify that the items in the cart are sorted alphabetically
            List<String> sortedProductNames = actualProductNames.stream()
                    .sorted(String::compareToIgnoreCase)
                    .toList();

            Assert.assertEquals(actualProductNames, sortedProductNames,
